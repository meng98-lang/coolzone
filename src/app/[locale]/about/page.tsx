        ...
        <section>
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
            <p className="text-blue-800 font-medium text-lg">
              Jinan Yuebei Amusement Equipment Co., Ltd.
            </p>
            <p className="text-blue-700 mt-2">
              Room 2304-24, Jingshu Talent Building, Weihai Road, Xingfu Street, Huaiyin District, Jinan City, Shandong Province, China
            </p>
          </div>
        </section>
